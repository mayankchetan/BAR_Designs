...
save_dir                    = './outputs/olaf-ed-test'#'/projects/bar/mchetan/projects/downwind/olaf-bd'
...
TMax        = 150.    # Length of wind grids and OpenFAST simulations, suggested 720 s
runTime     = 50.    # Suggested at 600. s
cut_in      = 8.    # Cut in wind speed
cut_out     = 9.   # Cut out wind speed
...
case_inputs[("Fst","DT")]               = {'vals':[0.002], 'group':0}
...
case_inputs[("AeroDyn15","OLAF","WrVTk")] = {'vals':[1], 'group':0}
...
case_list, case_name_list = CaseGen_General(case_inputs, dir_matrix=fastBatch.FAST_runDirectory, namebase='bar-usc-8')

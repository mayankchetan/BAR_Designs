...
parser.add_argument("--numCores", type = int, help = "Number of cores to use")
...
if eagleFlag:
    save_dir                = '/projects/bar/mchetan/projects/downwind/ad15-bd-stiff-torr/'
else:
    save_dir                = './outputs/ad15-bd/'

fastBatch.FAST_directory    = os.path.join(run_dir2,'../../../BAR_URC/' ,'of-olaf-stiff-torr') # Path to fst directory files
...
fastBatch.FAST_exe = '/home/mchetan/projects/bar-stability/openfast/of-ua-dbemt/build/glue-codes/openfast/openfast'
fastBatch.allow_fails = True
fastBatch.use_exe = True

fastBatch.magnitude_channels = {}
fastBatch.fatigue_channels   = {}

# Generate the matrix of cases
case_list, case_name_list = CaseGen_General(case_inputs, dir_matrix=fastBatch.FAST_runDirectory, namebase=f'bar-urc-{int(startWS)}')

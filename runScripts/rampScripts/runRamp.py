...
Run this script interactively in VS Code
...
TMax        = 3600.    # Length of wind grids and OpenFAST simulations, suggested 720 s
...
case_inputs[("AeroDyn15","WakeMod")]    = {'vals':[2], 'group':0}
...
case_inputs[("InflowWind","Filename_Uni")]       = {'vals':[str(run_dir2) + "UltraLongRamp.wnd"], 'group':0}
case_inputs[("InflowWind","RefHt_Uni")]       = {'vals':[140], 'group':0}
case_inputs[("InflowWind","RefLength")]       = {'vals':[1], 'group':0}
case_inputs[("InflowWind","OutList")]       = {'vals':["Wind1VelX"],'group':0}
